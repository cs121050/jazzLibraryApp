...
public class VideoDatabaseFeeder {
	...
	public String[] toStringArray() {
		...
		String[] toStringArray={artist_name,artist_instrument,video_link,video_name,video_duration,video_type,video_id,video_availability,"save","delete"};
		return  toStringArray;
	}
	
	public Object[] toObject() {

		Object[] toObject = new Object[] {artist_name,artist_instrument,video_link,video_name,video_duration,video_type,video_id,video_availability,"save","delete"};
