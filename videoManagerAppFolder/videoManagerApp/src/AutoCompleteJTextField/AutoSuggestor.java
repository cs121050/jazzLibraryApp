package AutoCompleteJTextField;
...
public class AutoSuggestor {
    ...
    private void showPopUpWindow() {
        ...
        if (suggestionsPanel.getHeight() > autoSuggestionPopUpWindow.getMinimumSize().height) {
            windowY = container.getY() + textField.getY() + autoSuggestionPopUpWindow.getMinimumSize().height+300;
        } else {
            windowY = container.getY() + textField.getY() + autoSuggestionPopUpWindow.getHeight()+300;
        }
