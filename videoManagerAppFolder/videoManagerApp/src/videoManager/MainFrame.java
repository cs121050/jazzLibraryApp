...
public class MainFrame extends JFrame {
	...
	public void prepareUI() { 
    	...
    	JScrollPane tableScrollPane = new JScrollPane(databaseFeedingFile_jT);
        ...
        registerAndDownload_Btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					fileUpDater(videoList,VideoManagerApp.databaseFeederFilePath);
    ...
    private void jTableOfFileDisplayInitialisation() throws IOException {
        ...
        AbstractAction save = new AbstractAction()
        {
            public void actionPerformed(ActionEvent e)
            {
                ...
                Video updatedVideo = ((MyDefaultTableModel)table.getModel()).getVideoAtRow(modelRow);
