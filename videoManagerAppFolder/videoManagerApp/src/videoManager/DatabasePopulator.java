...
public class DatabasePopulator extends JFrame {
    ...
    public DatabasePopulator() {
       ...
       databaseName_Lb=new JLabel(VideoManagerApp.databaseNames[databaseNames_Cb.getSelectedIndex()]);   //perneis to index kai travas to item apo thn thesh tou public String pinaka
