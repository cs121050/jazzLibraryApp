...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            List<SplashScreenQuotes> splashScreenQuotes = JazzLibraryDAO.retriveSplashScreenQuotes(con);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
                public void run(){
                    Intent intent= new Intent(SplashScreenActivity.this, jazzLibraryAppMainActivity.class);
