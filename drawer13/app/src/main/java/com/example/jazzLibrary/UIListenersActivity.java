...
public class UIListenersActivity<clickListener> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViews();
        autoCompleteEditTextSuggestionLoader();
        filterHandler();
        ...
        //emfaniso sto  videoLinearLayout!!
            public boolean onKey(View view, int keyCode, KeyEvent keyevent) {
                if ((keyevent.getAction() == KeyEvent.ACTION_DOWN) && (keyCode == KeyEvent.KEYCODE_ENTER)) {
                    ...
                    List<Video> videoList =searchBarVideoRetriever(editTxtSearchString);
    ...
    //kathe aritmos simbolizei ena chipGroup h alios mia katigoria (instrument:1  artist:2   type:3  duration:4    nothing:0)
        ...
        if (filterPathString.equals("0000")) { //none
            ...
            List<InstrumentAndArtistCount> instrumentAndArtistCount= JazzLibraryDAO.retriveInstrumentAndArtistCount_By();
            ...
            List<TypeAndVideoCount> typeAndVideoCount= JazzLibraryDAO.retriveTypeAndVideoCount_By();
            ...
            List<ArtistAndVideoCount> artistAndVideoCountList =JazzLibraryDAO.retriveArtistAndVideoCount_By(selectedInstrumentChipId);
            artistChipPopulator(artistAndVideoCountList);
            artistCountTextView.setText("::" + artistAndVideoCountList.size());


            List<TypeAndVideoCount> typeAndVideoCount= JazzLibraryDAO.retriveTypeAndVideoCount_By(selectedInstrumentChipId);
            typeChipPopulator(typeAndVideoCount);
            ...
            List<Video> videoList = JazzLibraryDAO.retriveVideo_By(selectedArtistChipId);
            videoLinearLayoutHandler(videoList);
            ...
            List<TypeAndVideoCount> typeAndVideoCount= JazzLibraryDAO.retriveTypeAndVideoCount_By(selectedArtistChipId,0);
            typeChipPopulator(typeAndVideoCount);
            ...
            List<InstrumentAndArtistCount> instrumentAndArtistCount= JazzLibraryDAO.retriveInstrumentAndArtistCount_By(selectedTypeChipId);
            instrumentChipPopulator(instrumentAndArtistCount);
            ...
            List<DurationAndVideoCount> durationAndVideoCount= JazzLibraryDAO.retriveDurationAndVideoCount_By(selectedTypeChipId);
            ...
            List<ArtistAndVideoCount> artistAndVideoCountList =JazzLibraryDAO.retriveArtistAndVideoCount_By(selectedInstrumentChipId,selectedTypeChipId);
            artistChipPopulator(artistAndVideoCountList);
            artistCountTextView.setText("::" + artistAndVideoCountList.size());
            ...
            List<DurationAndVideoCount> durationAndVideoCount=
                    JazzLibraryDAO.retriveDurationAndVideoCount_By(selectedTypeChipId,selectedInstrumentChipId);
            durationChipPopulator(durationAndVideoCount);
            ...
            List<InstrumentAndArtistCount> instrumentAndArtistCount= JazzLibraryDAO.retriveInstrumentAndArtistCount_By(selectedTypeChipId,selectedDurationChipId);
            instrumentChipPopulator(instrumentAndArtistCount);


            List<TypeAndVideoCount> typeAndVideoCount= JazzLibraryDAO.retriveTypeAndVideoCount_By(0,0,selectedTypeChipId,selectedDurationChipId);
            typeChipPopulator(typeAndVideoCount,selectedTypeChipId);
            ...
            List<InstrumentAndArtistCount> instrumentAndArtistCount
                    =JazzLibraryDAO.retriveInstrumentAndArtistCount_By(selectedTypeChipId,selectedDurationChipId);
            instrumentChipPopulator(instrumentAndArtistCount,selectedInstrumentChipId);


            List<ArtistAndVideoCount> artistAndVideoCountList
                    =JazzLibraryDAO.retriveArtistAndVideoCount_By(selectedInstrumentChipId,selectedTypeChipId,selectedDurationChipId);
            artistChipPopulator(artistAndVideoCountList);
            artistCountTextView.setText("::" + artistAndVideoCountList.size());


            List<TypeAndVideoCount> typeAndVideoCount
                    = JazzLibraryDAO.retriveTypeAndVideoCount_By(selectedInstrumentChipId,0,0,selectedDurationChipId,0);
            typeChipPopulator(typeAndVideoCount,selectedTypeChipId);
            ...
            List<Video> videoList = JazzLibraryDAO.retriveVideo_By(selectedArtistChipId,selectedTypeChipId);
            videoLinearLayoutHandler(videoList);
            ...
            List<DurationAndVideoCount> durationAndVideoCount=
                    JazzLibraryDAO.retriveDurationAndVideoCount_By(selectedTypeChipId,0,selectedArtistChipId);
            durationChipPopulator(durationAndVideoCount);
            ...
            List<Video> videoList = JazzLibraryDAO.retriveVideo_By(selectedArtistChipId,selectedTypeChipId,selectedDurationChipId);
            videoLinearLayoutHandler(videoList);
            ...
            List<TypeAndVideoCount> typeAndVideoCount
                    = JazzLibraryDAO.retriveTypeAndVideoCount_By(0,selectedArtistChipId,selectedDurationChipId);
            typeChipPopulator(typeAndVideoCount,selectedTypeChipId);
    ...
    public Chip chipTypeGenerator(InstrumentAndArtistCount instrumentAndArtistCount){
        ...
        LayoutInflater inflater = LayoutInflater.from(UIListenersActivity.this);
    ...
    //epita setarei parametrous gia apostaseis kai megethi , kai telos kolaei to video sto videoLinear layout
        YouTubePlayerView youTubePlayerView = new YouTubePlayerView(UIListenersActivity.this);
    ...
    public void autoCompleteEditTextSuggestionLoader(){
    ...
    //fortonei ta onomata se String[] , kalei  arrayAdapterSetter   pou prosartrei to string[] sto autocompeteedittext
        ...
        if (spinnerSelection.equals("Search Title")){
            ...
            String[] videoNames =JazzLibraryDAO.retriveVideoNames();
            arrayAdapterSetter(videoNames);
        }
        else if(spinnerSelection.equals("Search Artist")){

            String[] artistNames =JazzLibraryDAO.retriveArtistNames();
    ...
    public List<Video> searchBarVideoRetriever(String editTextValue){
        ...
        if(spinnerSelection.equals("Search Title")) {
            videoList = JazzLibraryDAO.retriveVideo_By(editTextValue);
        }
        else if(spinnerSelection.equals("Search Artist")) {

            String[] firstNameSurName = fullNameSeparator(editTextValue);
            videoList = JazzLibraryDAO.retriveVideo_By(firstNameSurName[0],firstNameSurName[1]);
        }
        else if(spinnerSelection.equals("Contains")) {
