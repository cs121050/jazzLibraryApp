package com.example.jazzLibraryAppClassies;

public class ArtistAndVideoCount {
    ...
    public int getArtist_video_count() { return artist_video_count; }

    public void setArtist_video_count(int artist_video_count) { this.artist_video_count = artist_video_count; }
}